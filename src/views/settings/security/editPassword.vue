...
<div>
  ...
  <div >
    ...
    <el-card class="checkcard">
      ...
      <el-button @click="phoneCheckForPassword">立即验证</el-button>
    </el-card>
    <el-card class="checkcard">
      <h1>邮箱验证</h1>
      <p>若绑定的邮箱可用，可向已绑定的邮箱发送验证码以修改密码</p>
      <el-button @click="emailCheckForPassword">立即验证</el-button>
    </el-card>
    <el-card class="checkcard">
      <h1>以上方式均无法使用</h1>
      <p>若您绑定的手机、邮箱均无法使用，请联系我们</p>
      <el-button @click="help">联系我们</el-button>
    </el-card>
  </div>
